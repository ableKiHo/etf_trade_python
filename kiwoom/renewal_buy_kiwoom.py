...
class RenewalBuyKiwoom(ParentKiwoom):
    def __init__(self):
        ...
        self.target_etf_dict = {
            '252670': {self.customType.STOCK_CODE: '252670', "tic": "120틱", self.customType.STOCK_NAME: 'KODEX 200선물인버스2X', "divide_plus_std_price": 0.5, "max_plus_std_price": 1.0, "min_tic": 4},
            '233740': {self.customType.STOCK_CODE: '233740', "tic": "120틱", self.customType.STOCK_NAME: 'KODEX 코스닥150 레버리지', "divide_plus_std_price": 0.6, "max_plus_std_price": 2.0, "min_tic": 4},
            '122630': {self.customType.STOCK_CODE: '122630', "tic": "120틱", self.customType.STOCK_NAME: 'KODEX 레버리지', "divide_plus_std_price": 0.6, "max_plus_std_price": 2.0, "min_tic": 4},
            '251340': {self.customType.STOCK_CODE: '251340', "tic": "60틱", self.customType.STOCK_NAME: 'KODEX 코스닥150선물인버스', "divide_plus_std_price": 0.5, "max_plus_std_price": 1.0, "min_tic": 4},
        }
    ...
    def new_chejan_slot(self, sGubun, nItemCnt, sFidList):
        ...
        if int(sGubun) == 0:
            ...
            if meme_gubun == self.customType.SELL:
                ...
                if "divide_minus_std_price" not in self.buy_point_dict.keys() or self.buy_point_dict["divide_minus_std_price"] > 0:
